  ...
  try {
    ...
    const result = await db.transaction(async (client) => {
      ...
      const userResult = await client.query(
        'INSERT INTO users (name, email, password, company_id, role, is_beta, subscription_status, trial_start_date, trial_end_date, created_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9, NOW()) RETURNING id, email, name, role, subscription_status, trial_end_date',
        [name, email, hashedPassword, companyId, 'admin', true, 'trial', trialStartDate, trialEndDate]
      );
